    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                //Adminok sima usert leszámítva tudjanak regisztrálni cégeket, adminokat
            ...
            {
                //Employee csak Company rollal tudjon regisztrálni
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            //If is an error while registration
            Input = new InputModel()
            {
                CompanyList = (await _unitOfWork.Company.GetAllAsync()).Select(i => new SelectListItem
                {
